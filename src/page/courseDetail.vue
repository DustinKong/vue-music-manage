        ...
        <el-row style="margin-top: 10px;">
            <el-col :span="12" :offset="4">
                <el-form :model="courseInfo" :rules="rules" ref="courseInfo" label-width="110px" class="demo-courseInfo">
                    ...
                    <el-form-item label="课程时数" v-if="courseInfo.exactCourses">
                        <el-input v-model="courseInfo.classHour"></el-input>
                    </el-form-item>
                    <el-form-item label="已买人数"  v-if="courseInfo.exactCourses">
                        <el-input v-model="courseInfo.exactCourses[0].buyNum"></el-input>
                    </el-form-item>
                    <el-form-item label="课程最大人数"  v-if="courseInfo.exactCourses">
                        <el-input v-model="courseInfo.exactCourses[0].openingNum"></el-input>
                    </el-form-item>
                    <p>主图 首页展示</p>
