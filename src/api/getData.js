...
export const loginWeb = data => fetch('/login', data, 'POST');

export const getFirstType = () => fetch('/getFirstData');

export const getSecondType = id => fetch('/getSecondData',{id:id});

export const addLink = data => fetch('/addLink', data, 'POST');

export const updateLink = data => fetch('/updateLink', data, 'POST');

export const deleteLink = data => fetch('/deleteLink', data, 'POST');
